"""Entrypoint for the Doing Laundry task (rulebook 5.4).

    uv run python -m tasks.Laundry.run
    DISABLE_LISTENING=1 uv run python -m tasks.Laundry.run   # type instead of speak
