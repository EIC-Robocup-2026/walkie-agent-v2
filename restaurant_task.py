...
def run_restaurant_task_stage(walkieAI, walkie: WalkieRobot, db, model) -> None:
    ...
    try:
        ...
        input("Press to continue...")
        walkie.arm.go_to_pose_relative(x=0.1, y=0, z=0.1, roll=0, pitch=-1.57, yaw=0, blocking=True)
        input("Press to continue...")
        walkie.arm.control_gripper("left_gripper", 0.7, blocking=True)
        walkie.arm.go_to_pose_relative(x=-0.1, y=0, z=0.1, roll=0, pitch=0, yaw=0, blocking=True)
