...
(Run on the GPU box — tasks.common pulls the device stack; the real dependency is
OPENROUTER_API_KEY for order parsing.)
"""
...
from client import DetectedObject, PersonPose, PoseKeypoint
...
class _Image:
    ...
    def detect(self, img, prompts=None, return_mask=False):
        ...
        return [DetectedObject(mask=None, bbox=(260, 80, 380, 400), area_ratio=0.1,
                               class_name=name, confidence=0.9)]
